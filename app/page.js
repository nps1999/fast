...
const COUNTRY_CODES = [
  { code: '+966', name: 'السعودية', flag: '\u{1F1F8}\u{1F1E6}' }, { code: '+965', name: 'الكويت', flag: '\u{1F1F0}\u{1F1FC}' },
  { code: '+971', name: 'الإمارات', flag: '\u{1F1E6}\u{1F1EA}' }, { code: '+973', name: 'البحرين', flag: '\u{1F1E7}\u{1F1ED}' },
  { code: '+974', name: 'قطر', flag: '\u{1F1F6}\u{1F1E6}' }, { code: '+968', name: 'عمان', flag: '\u{1F1F4}\u{1F1F2}' },
  { code: '+962', name: 'الأردن', flag: '\u{1F1EF}\u{1F1F4}' }, { code: '+961', name: 'لبنان', flag: '\u{1F1F1}\u{1F1E7}' },
  { code: '+20', name: 'مصر', flag: '\u{1F1EA}\u{1F1EC}' }, { code: '+964', name: 'العراق', flag: '\u{1F1EE}\u{1F1F6}' },
  { code: '+967', name: 'اليمن', flag: '\u{1F1FE}\u{1F1EA}' }, { code: '+970', name: 'فلسطين', flag: '\u{1F1F5}\u{1F1F8}' },
  { code: '+212', name: 'المغرب', flag: '\u{1F1F2}\u{1F1E6}' }, { code: '+216', name: 'تونس', flag: '\u{1F1F9}\u{1F1F3}' },
  { code: '+213', name: 'الجزائر', flag: '\u{1F1E9}\u{1F1FF}' }, { code: '+249', name: 'السودان', flag: '\u{1F1F8}\u{1F1E9}' },
  { code: '+1', name: 'أمريكا', flag: '\u{1F1FA}\u{1F1F8}' }, { code: '+44', name: 'بريطانيا', flag: '\u{1F1EC}\u{1F1E7}' },
  { code: '+90', name: 'تركيا', flag: '\u{1F1F9}\u{1F1F7}' },
];
      ...
      <div className="container mx-auto px-4 py-3"><div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Select value={currency} onValueChange={changeCurrency}>
            ...
            <SelectContent className="bg-[#12121f] border-purple-500/20">{Object.entries(CURRENCIES).map(([k,v]) => <SelectItem key={k} value={k}><span>{v.symbol} {k}</span></SelectItem>)}</SelectContent>
          </Select>
  ...
  const CheckoutPage = () => {
    ...
    return (<div className="animate-fade-in max-w-2xl mx-auto">
      ...
      <Button size="lg" className="w-full bg-purple-600 hover:bg-purple-500 text-lg py-6 neon-glow" onClick={placeOrder} disabled={proc}>
        {proc ? <Loader2 className="w-5 h-5 animate-spin ml-2" /> : <Zap className="w-5 h-5 ml-2" />}{proc ? 'جاري المعالجة...' : 'تأكيد الطلب'}
      </Button>
    </div>);
  };
